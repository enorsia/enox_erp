                        ...
                        <div class="grid grid-cols-1 gap-4">
                            ...
                            <div>
                                ...
                                <input type="text" name="name"
                                       ...
                                       value="{{ $salePlatform->name ?? old('name') }}" required />
                                @error('name')
                            ...
                            <div>
                                ...
                                <input type="text" name="slug" id="slug"
                                       ...
                                       value="{{ $salePlatform->slug ?? old('slug') }}" />
                            ...
                            <div>
                                ...
                                <select name="type" class="tom-select f-input @error('type') border-red-400 @enderror" required>
                                    ...
                                    @foreach ($types as $type)
                                        <option value="{{ $type }}" {{ ($salePlatform->type ?? old('type')) == $type ? 'selected' : '' }}>
                            ...
                            <div>
                                ...
                                <select name="parent_id" class="tom-select f-input @error('parent_id') border-red-400 @enderror" data-placeholder="Select Parent Platform">
                                    ...
                                    @foreach ($parentPlatforms as $parent)
                                        <option value="{{ $parent->id }}" {{ ($salePlatform->parent_id ?? old('parent_id')) == $parent->id ? 'selected' : '' }}>
                                            {{ $parent->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div>
                                ...
                                <input type="number" name="sort_order" min="0" max="255"
                                       ...
                                       value="{{ $salePlatform->sort_order ?? old('sort_order', 0) }}" />
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                <label class="flex items-center gap-3 cursor-pointer">
                                    <div class="toggle-track {{ $salePlatform->is_active ? 'on' : '' }}" id="statusToggle" onclick="toggleSwitch('statusToggle')">
                                    ...
                                    <input type="checkbox" name="is_active" id="statusCheckbox" class="hidden"
                                           {{ $salePlatform->is_active ? 'checked' : '' }}>
                                </label>
