...
@section('title', 'Create Monthly Budget')
...
@section('content')
    ...
    <div class="max-w-5xl mx-auto px-5 py-6 pb-28">
        ...
        <div class="flex items-center justify-between mb-6 flex-wrap gap-3">
            <div>
                <h1 class="text-xl font-semibold text-slate-800 dark:text-slate-100">Create New Monthly Budget</h1>
                <p class="text-sm text-slate-400 dark:text-slate-500 mt-0.5">Fill in the details below to create a new monthly budget</p>
            </div>
        </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-[1fr_300px] gap-5">
                ...
                <div class="space-y-5">
                    ...
                    <div class="section-card">
                        ...
                        <p class="section-desc">Enter the details for this monthly budget.</p>
                                ...
                                <div>
                                    ...
                                    <select name="year" class="tom-select f-input @error('year') border-red-400 @enderror" required>
                                        ...
                                        @foreach($years as $yearOption)
                                            <option value="{{ $yearOption }}" {{ old('year', date('Y')) == $yearOption ? 'selected' : '' }}>
                                                {{ $yearOption }}
                                            </option>
                                        @endforeach
                                    </select>
                        ...
                        <div class="grid grid-cols-1 gap-4">
                            ...
                            <div>
                                ...
                                <input type="text" name="currency" maxlength="3"
                                       ...
                                       placeholder="e.g. GBP" value="{{ old('currency', 'GBP') }}" required />
                                @error('currency')
                                    <p class="f-error">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                <textarea name="notes"
                                          ...
                                          placeholder="Add any relevant notes..." rows="5">{{ old('notes') }}</textarea>
                                @error('notes')
                                    <p class="f-error">{{ $message }}</p>
                                @enderror
                            </div>
