                ...
                <div x-data="{ drawerPeriod: @js($period) }">
                    <label class="etd-filter-compact-field">
                        ...
                        <select name="period"
                            ...
                            @foreach (['24h' => \App\Support\TrackerTime::todayPresetButtonLabel(), 'yesterday' => \App\Support\TrackerTime::yesterdayPresetButtonLabel(), '7d' => '7 days', '30d' => '30 days', '90d' => '90 days', 'custom' => 'Custom'] as $periodKey => $periodOptionLabel)
