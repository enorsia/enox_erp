...
@section('content')
    <div class="max-w-3xl mx-auto px-5 py-6 pb-28">
        ...
        <div class="flex items-center justify-between mb-6 flex-wrap gap-3">
            <div>
                <h1 class="text-xl font-semibold text-slate-800 dark:text-slate-100">Create Platform</h1>
                <p class="text-sm text-slate-400 dark:text-slate-500 mt-0.5">Add a new sales platform</p>
            </div>
        </div>

        <form action="{{ route('admin.platforms.store') }}" method="POST" id="platformCreateForm">
            @csrf
            ...
            <div class="section-card">
                ...
                <p class="section-desc">Enter the details for the new platform.</p>

                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <!-- Platform Name -->
                    <div>
                        <label for="platform_name" class="f-label">Platform Name <span class="f-required">*</span></label>
                        <input type="text" name="platform_name" id="platform_name"
                               class="f-input @error('platform_name') border-red-400 @enderror"
                               value="{{ old('platform_name') }}" placeholder="e.g. Amazon" required />
                        @error('platform_name') <p class="f-error">{{ $message }}</p> @enderror
                    </div>

                    <!-- Platform Code -->
                    <div>
                        <label for="code" class="f-label">Platform Code <span class="f-required">*</span></label>
                        <input type="text" name="code" id="code"
                               class="f-input @error('code') border-red-400 @enderror"
                               value="{{ old('code') }}" placeholder="e.g. AMZ" required />
                    ...
                    <div>
                        ...
                        <input type="number" name="shipping_charge" id="shipping_charge"
                               ...
                               value="{{ old('shipping_charge') }}" placeholder="0.00" step="0.01" />
                    ...
                    <div>
                        ...
                        <input type="number" name="min_profit" id="min_profit"
                               ...
                               value="{{ old('min_profit') }}" placeholder="0.00" step="0.01" required />
                    ...
                    <div>
                        ...
                        <input type="number" name="commission" id="commission"
                               ...
                               value="{{ old('commission') }}" placeholder="e.g. 0.15 for 15%" step="0.001" required />
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <textarea name="note" id="note"
                                  ...
                                  rows="3" placeholder="Optional note...">{{ old('note') }}</textarea>
