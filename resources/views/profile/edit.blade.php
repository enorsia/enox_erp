...
@section('content')
    <div class="max-w-5xl mx-auto px-5 py-6 pb-28">
        ...
        <div class="flex items-center justify-between mb-6 flex-wrap gap-3">
            <div>
                <h1 class="text-xl font-semibold text-slate-800 dark:text-slate-100">Edit Profile</h1>
                <p class="text-sm text-slate-400 dark:text-slate-500 mt-0.5">Update your account details</p>
            </div>
        </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-[1fr_300px] gap-5">
                ...
                <div class="space-y-5">
                    ...
                    <div class="section-card">
                        ...
                        <p class="section-desc">Update your personal account details.</p>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <input type="text" name="designation" class="f-input"
                                    value="{{ $user->designation ?? old('designation') }}" placeholder="e.g. Manager" />
                    ...
                    <div class="section-card">
                        ...
                        <p class="section-desc">Update your profile photo.</p>
                        ...
                        <img class="image-preview mt-3 w-[120px] rounded-lg"
                            ...
                            src="{{ $user->avatar ? cloudflareImage($user->avatar, 150) : cloudflareImage('eca4fbfc-baba-4ac2-0966-e8a13d097700', 150) }}"
                            alt="Preview">
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                <label class="flex items-center gap-3 cursor-pointer">
                                    <div class="toggle-track {{ $user->status ? 'on' : '' }}" id="statusToggle"
