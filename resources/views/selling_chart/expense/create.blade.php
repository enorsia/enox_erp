...
@section('content')
    <div class="max-w-5xl mx-auto px-5 py-6 pb-28">
        ...
        <div class="flex items-center justify-between mb-6 flex-wrap gap-3">
            <div>
                <h1 class="text-xl font-semibold text-slate-800 dark:text-slate-100">Create New Expense</h1>
                <p class="text-sm text-slate-400 dark:text-slate-500 mt-0.5">Fill in the details below to create a new expense record
                </p>
            </div>
        </div>

        <form method="POST" action="{{ route('admin.selling_chart.expense.store') }}" id="expenseForm">
            @csrf
            ...
            <div class="space-y-5">
                ...
                <div class="section-card">
                    ...
                    <p class="section-desc">Enter the expense details for the selling chart.</p>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="conversion_rate"
                                ...
                                value="{{ old('conversion_rate') }}" placeholder="e.g. 1.25" required />
                        ...
                        <div>
                            ...
                            <input type="text" name="commercial_expense"
                                ...
                                value="{{ old('commercial_expense') }}" placeholder="e.g. 500.00" required />
                        ...
                        <div>
                            ...
                            <input type="text" name="enorsia_expense_bd"
                                ...
                                value="{{ old('enorsia_expense_bd') }}" placeholder="e.g. 300.00" required />
                        ...
                        <div>
                            ...
                            <input type="text" name="enorsia_expense_uk"
                                ...
                                value="{{ old('enorsia_expense_uk') }}" placeholder="e.g. 200.00" required />
                        ...
                        <div>
                            ...
                            <input type="text" name="shipping_cost"
                                ...
                                value="{{ old('shipping_cost') }}" placeholder="e.g. 50.00" />
                            @error('shipping_cost')
                                <p class="f-error">{{ $message }}</p>
                            @enderror
                        </div>
