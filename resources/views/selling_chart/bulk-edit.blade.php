...
@section('content')
    ...
    <div class="row justify-content-center">
        <div class="col-12">
            <div class="card-dark main-card mb-3 card p-0" id="selling_chart_view_table_edit">
                <div class="card-body">
                                                            ...
                                                            <tr>
                                                                <td class="text-center">
                                                                    ...
                                                                    @php
                                                                        ...
                                                                        $season_year =
                                                                            $current_century . trim($season_name_year);
                                                                        $expense = $expenses
                                                                            ->where('year', (int) $season_year)
                                                                            ->first();
                                                                    @endphp

                                                                    <input class="expense_input" type="hidden"
                                                                        name="expense_input" value="{{ $expense?->year }}"
                                                                ...
                                                                <td><input readonly value="{{ $ch_price->color_code }}"
                                                                        type="text" name="color_code[]"
                                                                        class="color_code"></td>
                                                                <td><input readonly value="{{ $ch_price->color_name }}"
                                                                ...
                                                                @endif
                                                                <td><input value="{{ $ch_price->po_order_qty }}"
                                                                        type="number" name="po_order_qty[]"
                                                                        class="po_order_qty ctmr"></td>
                                                                <td><input value="{{ $ch_price->price_fob }}"
                                                                        type="number" name="price_fob[]"
                                                                        class="price_fob ctmr">
                                                                </td>
                                                                <td><input value="{{ $ch_price->unit_price }}"
                                                                        type="number" name="unit_price[]"
                                                                        class="unit_price" readonly></td>
                                                                ...
                                                                <td><input
                                                                        ...
                                                                        class="shipping_cost"></td>
                                                                <td><input value="{{ $ch_price->confirm_selling_price }}"
                                                                        type="number" name="confirm_selling_price[]"
                                                                        class="confirm_selling_price"></td>
                                                                <td><input value="{{ $ch_price->vat_price }}"
                                                                        type="number" name="seling_vat[]"
                                                                        class="seling_vat" readonly></td>
                                                                <td><input value="{{ $ch_price->vat_value }}"
                                                                        type="number" name="seling_vat_value[]"
                                                                        class="seling_vat_value" readonly></td>

                                                                <td><input value="{{ $ch_price->profit_margin }}"
                                                                        type="number" name="profit_margin[]"
                                                                        class="profit_margin" readonly></td>
                                                                <td><input value="{{ $ch_price->net_profit }}"
                                                                        type="number" name="net_profit[]"
                                                                        class="net_profit" readonly></td>
                                                                <td><input value="{{ $ch_price->discount }}"
                                                                ...
                                                                <td><input value="{{ $ch_price->discount_vat_price }}"
                                                                        type="number" name="selling_vat_dedact_price[]"
                                                                        class="selling_vat_dedact_price" readonly></td>
                                                                <td><input value="{{ $ch_price->discount_vat_value }}"
                                                                        type="number" name="discount_vat_value[]"
                                                                        class="discount_vat_value" readonly></td>
