...
<div class="px-5 py-6 pb-28">
    ...
    <div class="flex items-center justify-between mb-5 flex-wrap gap-3">
        <div>
            ...
            <p class="text-sm text-slate-400 dark:text-slate-500 mt-0.5">Record one or more daily return entries for a single date</p>
        </div>
    </div>
        ...
        <div class="section-card !mb-4">
            <div class="flex flex-wrap items-end gap-5">
                <div class="w-56">
                    ...
                    <input type="date" name="date" id="return-date"
                ...
                <p class="text-xs text-slate-400 dark:text-slate-500 pb-1.5">
                    All return entries below will be saved for this date.
                </p>
            </div>
        </div>
