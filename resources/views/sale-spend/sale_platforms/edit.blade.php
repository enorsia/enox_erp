                    ...
                    <div class="section-card">
                        ...
                        <div class="space-y-3">
                            ...
                            <div class="pt-2 border-t border-slate-100 dark:border-slate-700">
                                ...
                                <div>
                                    <div class="flex items-center gap-3 cursor-pointer">
                                        <div class="toggle-track {{ old('allows_budget_direct_entry', $salePlatform->allows_budget_direct_entry ?? true) ? 'on' : '' }}" id="allowsBudgetDirectEntryToggle"
                                        ...
                                        <input type="checkbox" name="allows_budget_direct_entry" id="allowsBudgetDirectEntryCheckbox" class="hidden"
                                                {{ old('allows_budget_direct_entry', $salePlatform->allows_budget_direct_entry ?? true) ? 'checked' : '' }}>
                                    </div>
