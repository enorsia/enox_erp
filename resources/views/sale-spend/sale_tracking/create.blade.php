...
@section('title', 'Add Sale Tracking')
...
<div class="px-5 py-6 pb-28">
    ...
    <div class="flex items-center justify-between mb-5 flex-wrap gap-3">
        <div>
            <h1 class="text-xl font-semibold text-slate-800 dark:text-slate-100">Add Sale Tracking</h1>
            <p class="text-sm text-slate-400 dark:text-slate-500 mt-0.5">Record monthly ad performance — one card per platform</p>
        </div>
    </div>
    ...
    <form method="POST" action="{{ route('admin.ads-performance.store') }}" id="stForm">
        @csrf
        ...
        <div class="section-card !mb-4">
            <div class="flex flex-wrap items-end gap-5">
                ...
                <p class="text-xs text-slate-400 dark:text-slate-500 pb-1.5">
                    All platform cards below will be saved for this month.
                </p>
            </div>
        </div>
