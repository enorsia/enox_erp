    ...
    */
    ...
    'options' => [
        ...
        'db' => [
            ...
            'slow_threshold'    => is_numeric(env('DEBUGBAR_OPTIONS_DB_SLOW_THRESHOLD'))
                ? (float) env('DEBUGBAR_OPTIONS_DB_SLOW_THRESHOLD')
                : false, // Max query execution time (ms). Exceeding queries will be highlighted
